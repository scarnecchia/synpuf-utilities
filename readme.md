...
In order to run a query using Sentinel's reusable Modular Program tools on the SynPUFs, you will need to start with a CIDA package.



version of CIDA, new package, use already parameterized one