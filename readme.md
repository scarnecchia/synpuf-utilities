...
\>>[Continue on to the System Requirements for running a CIDA package](https://dev.sentinelsystem.org/projects/SYNPUF/repos/synpuf_user_documentation/browse/file10_system.md)
