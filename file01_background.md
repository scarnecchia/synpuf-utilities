...
<br><br>
Continue reading about using the SCDM-formatted SynPUFs in a [demonstration Sentinel CIDA package] (projects/SYNPUF/repos/synpuf_user_documentation/browse/file10_demo.md).
